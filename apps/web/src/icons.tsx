...
export const Icon = {
  ...
  arrowLeft: make(<path d="M19 12H5M11 18l-6-6 6-6" />),
  panelLeft: make(<><rect x="3" y="4" width="18" height="16" rx="2" /><path d="M9 4v16" /><path d="M6.5 10l-1.5 2 1.5 2" /></>),
  panelRight: make(<><rect x="3" y="4" width="18" height="16" rx="2" /><path d="M15 4v16" /><path d="M17.5 10l1.5 2-1.5 2" /></>),
